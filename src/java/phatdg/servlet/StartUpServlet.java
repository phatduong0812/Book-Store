...
public class StartUpServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        String url = MyAppConstants.StartUpServlet.LOGIN_PAGE;
        try {
            ...
            if (cookies != null) {
                ...
                if (validUser != null) {
                    ...
                    url = MyAppConstants.StartUpServlet.PROFILE_PAGE;
                }
            }
        } catch (SQLException e) {
            log("StartUpServlet _ SQL _ " + e.getMessage());
        } catch (NamingException e) {
            log("StartUpServlet _ Naming _" + e.getMessage());
        } finally {
